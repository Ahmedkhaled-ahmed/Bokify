...
export default function Header() {
  ...
  return <>
    <header className="bg-[#F6F4DF] min-h-[85vh] relative pt-20">
  ...
  <div className="overflow-hidden">
    ...
    >
      ...
      <div className="w-1/2 grid grid-cols-1 lg:grid-cols-3 items-center gap-4 px-4">
        ...
        <img src={head1} alt="headpic" className="mx-auto w-full max-w-sm" />
        <h1 className="text-center text-3xl md:text-5xl font-[Mali]">
      ...
      <div className="w-1/2 grid grid-cols-1 lg:grid-cols-3 items-center gap-4 px-4">
        ...
        <img src={head2} alt="headpic" className="mx-auto w-full max-w-sm" />
        <h1 className="text-center text-3xl md:text-5xl font-[Mali]">
